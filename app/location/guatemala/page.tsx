        ...
        <div className="relative overflow-hidden rounded-[2rem] border border-border bg-card shadow-sm">
          ...
          <div className="relative space-y-10 px-6 py-14 sm:px-10 lg:px-14">
            ...
            <section className="rounded-3xl border border-border bg-background/90 p-8 shadow-sm backdrop-blur-sm">
              <h2 className="text-2xl font-semibold text-foreground mb-4">Why InnovazionE in Guatemala?</h2>
              <p className="text-base leading-8 text-muted-foreground mb-8">
                We combine deep local knowledge with technical engineering expertise to help projects succeed under the unique conditions of Guatemala. Our approach covers risk evaluation, structural resilience, and project delivery support.
              </p>
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                <div className="rounded-2xl bg-card p-6 shadow-sm border border-border">
                  ...
                  <p className="text-sm leading-7 text-muted-foreground">
                    Guatemala’s metropolitan growth and institutional assets require advanced structural analysis and high-performance resilience strategies.
                  </p>
                </div>
                <div className="rounded-2xl bg-card p-6 shadow-sm border border-border">
