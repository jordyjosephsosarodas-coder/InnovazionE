...
const rich = getDepartmentRichContent("chimaltenango")!
const path = "/location/chimaltenango"
...
export const metadata: Metadata = {
  ...
  keywords: [
    "ingeniería civil Chimaltenango",
    "ingeniería estructural Guatemala",
    "planos para construcción AGIES",
...
export default function Page() {
  return <EnhancedLocationPage slug="chimaltenango" />
}
