    ...
    <section id="services" className="py-24 lg:py-32 bg-card">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-16 max-w-4xl">
          ...
          <p className="text-base text-muted-foreground leading-relaxed hyphens-auto text-justify">
            {t.services.title}
          </p>
        </div>
          ...
          {t.services.categories.map((category, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-sm text-accent mb-6 italic hyphens-auto text-justify">
                  {category.target}
                </p>
